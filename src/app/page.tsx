...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[#F4F7F4] text-[#111827] font-sans overflow-x-hidden selection:bg-[#113D2B]/15 selection:text-[#113D2B]">
      ...
      {/* ─── Hero: High-Impact 3-Card Grid ─── */}
      <section className="px-4 sm:px-6 lg:px-8 pt-4 pb-8">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-4 min-h-[75vh]">
          {/* Card 1 — Deep Forest Pine, Bold Type with Staggered Word Reveal */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
            className="bg-[#113D2B] text-white p-8 sm:p-12 rounded-3xl flex flex-col justify-end relative overflow-hidden min-h-[48vh] md:min-h-0 shadow-sm"
          >
            <motion.h1
              {...staggerContainer(0.08)}
              className="font-[family-name:var(--font-display)] text-[clamp(3.5rem,10vw,7.5rem)] font-bold leading-[0.88] tracking-[-0.04em] uppercase text-white"
            >
              {HERO_WORDS.map((word) => (
          ...
          {/* Card 2 — Crisp White, Massive Type & Real Engineering Truth */}
          <motion.div
            {...fadeUp(0.2)}
            className="bg-white border border-[#E5EBE5] text-[#111827] p-8 sm:p-12 rounded-3xl flex flex-col justify-between min-h-[48vh] md:min-h-0 shadow-2xs"
          >
            <div>
              <h2 className="font-[family-name:var(--font-display)] text-[clamp(2.8rem,6.5vw,5.2rem)] font-bold leading-[0.88] tracking-[-0.03em] uppercase text-[#111827]">
                Honest
                <br />
                Audit.
                <br />
            ...
            <div className="pt-8 mt-auto">
              ...
              <p className="text-xs sm:text-sm text-[#6B7280] mt-4 leading-relaxed">
                No vanity metrics. No inflated scores. An actionable engineering diagnostic.
              </p>
            </div>
          </motion.div>

          {/* Card 3 — Warm Golden Butter Yellow, Massive Serif Type + CTA */}
          <motion.div
            {...fadeUp(0.3)}
            className="bg-[#F2C94C] text-[#111827] p-8 sm:p-12 rounded-3xl flex flex-col justify-between min-h-[48vh] md:min-h-0 shadow-sm"
          >
            <div>
              <h2 className="font-[family-name:var(--font-display)] text-sm font-bold uppercase tracking-wider text-[#111827]/80">
            ...
            <div className="pt-8 mt-auto">
              <div className="overflow-hidden">
                <motion.p
                  {...slideUp(0.4)}
                  className="font-serif italic text-[clamp(3.5rem,7.5vw,6rem)] leading-[0.88] text-[#111827] tracking-tight"
                >
                  before
                  <br />
                  you apply.
      ...
      {/* ─── Bottom CTA Banner ─── */}
      <section className="p-4 sm:px-6 lg:px-8 py-10">
